...
if (temperature >= 80 && rain === true) {
  ...
  console.log("Wear a t-shirt, and long pants.");
} else if (temperature <= 60 && rain !== true) {
  console.log("Wear a long sleeve shirt, and bring a jacket.");
}
...
while (score < 7) {
  console.log("Your score is not high enough - current score is: " + score);
  score++;
}
